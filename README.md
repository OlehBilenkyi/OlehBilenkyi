    ...
    <tr>
      <td>
        <img src="assets/img/olehbilenkyi.jpeg" 
             ...
             style="border: 3px solid #FF00FF; border-radius: 10px; box-shadow: 0 0 15px #00FF9F;">
      </td>
      <td align="center" style="vertical-align: middle;">
        <img src="https://media.giphy.com/media/U7IxSYwucpNXJzWrqg/giphy.gif" width="50"><br>
        <strong style="font-size: 20px; color: #00FF9F;">Oleh Bilenkyi</strong>
      </td>
    </tr>
  </table>
</div>
